...
Run the bundled `list-backups.sh` script below and present the result to the user. If there are no backups, tell them they can run `/toby-claude-config:claude-backup` to create one.
